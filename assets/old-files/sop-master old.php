...
<script>
    $(document).ready(function() {
        ...
        setInterval(function() {
            getSOPMaster(); // Reload data with selected filters every 20 seconds
        }, 2000);
    });
        ...
        $.post("crud-sopmaster.php", {
            ...
            response.forEach(function(row, index) {
                var tableRow = '<tr>' +
                    ...
                    '<td>' +
                    '<a href="sop-detail.php?NoSOP=\'' + row.NoSOP + '\'" class="btn btn-outline-secondary btn-sm me-1">Detail</a>' +
